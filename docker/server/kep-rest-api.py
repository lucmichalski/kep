"""
The simple example serving KEP as a rest api.
...
def handle_kep():
    """Example endpoint return a list of keywords using KEP
    ---
    consumes:
      - application/json
    produces:
    ...
    try:
        ...
        my_kep = kep.KeywordExtractor(lan=language,
                                        n=max_ngram_size,
        ...
        sentences = my_kep.extract_keywords(text)
        result  = [{"ngram":x[1] ,"score":x[0]} for x in sentences]
